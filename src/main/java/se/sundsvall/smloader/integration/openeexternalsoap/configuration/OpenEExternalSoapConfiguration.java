...
public class OpenEExternalSoapConfiguration {

	public static final String CLIENT_ID = "open-e-external-soap";
	...
	@Bean
	FeignBuilderCustomizer feignBuilderCustomizer(OpenEExternalSoapProperties properties) {
