...
record OrderingRecruitmentSupport(
	...
	@XPath("/FlowInstance/Values/temporaryDate/EndDate") String temporaryEndDate,
	@XPath("/FlowInstance/Values/scope/percentage") String scopePercentage,
	@XPath("/FlowInstance/Values/numberOfPositions/Antal_tjanster") String numberOfPositions,
	@XPath("/FlowInstance/Values/recruitmentAccess/*") @GenericType(RecruitmentAccess.class) List<RecruitmentAccess> recruitmentAccess,
	@XPath("/FlowInstance/Values/recruitmentAccess/Name") String recruitmentAccessName,
	...
	@XPath("/FlowInstance/Values/advertisementContacts/Name") String advertisementContactsName,
	@XPath("/FlowInstance/Values/unionContacts/*") @GenericType(UnionContact.class) List<UnionContact> unionContacts,
	@XPath("/FlowInstance/Values/unionContacts/Name") String unionContactsName,
