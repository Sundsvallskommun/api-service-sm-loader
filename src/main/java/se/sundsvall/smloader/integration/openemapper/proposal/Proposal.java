...
record Proposal(
	...
	@XPath("/FlowInstance/Values/contact/Address") String address,

	@XPath("/FlowInstance/Values/contact/ZipCode") String zipCode,

	@XPath("/FlowInstance/Values/contact/PostalAddress") String postalAddress,

	@XPath("/FlowInstance/Values/contact/ContactBySMS") Boolean contactBySMS,
