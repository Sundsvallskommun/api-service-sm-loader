...
record SalaryChange(
	...
	@XPath("/FlowInstance/Header/Owner/Firstname")
	String ownerFirstname,

	@XPath("/FlowInstance/Header/Owner/Lastname")
	String ownerLastname,

	@XPath("/FlowInstance/Header/Owner/Email")
	String ownerEmail,
	...
	@XPath("/FlowInstance/Values/salary/Ange_det_belopp_du_vill_lonevaxla__minimum_500kr_")
	String amount,

	@XPath("/FlowInstance/Values/fromMonth/Value")
	String fromMonth) { }
